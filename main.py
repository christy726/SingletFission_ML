...
def main():
    ...
    plot_learning_curves(train_losses, val_losses, 
                        'Pretraining (400K SMILES)', 'pretraining_18_03_2025.png')
    ...
    plot_learning_curves(train_losses, val_losses, 
                        'Fine-tuning', 'finetuning_18_03_2025.png')
    ...
    pd.DataFrame(generated, columns=['SMILES']).to_csv('data/generated_smiles_18_03_2025', index=False)
