...
def main():
    ...
    pd.DataFrame(new_smiles, columns=['SMILES']).to_csv('data/generated_smiles_01_04_2025.csv', index=False)
    logging.info("Generated SMILES saved to 'data/generated_smiles_01_04_2025.csv'")
