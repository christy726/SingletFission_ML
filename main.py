...
def main():
    ...
    selected_gdb17_smiles = gdb17_smiles[:500]
    ...
    train_losses, val_losses = pretrain_clm(clm_model,combined_smiles,char_to_idx,device,epochs=2,batch_size=128,lr=0.001,seq_len=seq_len)
