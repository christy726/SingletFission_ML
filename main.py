...
def main():
    ...
    augmented_smiles = load_augmented_data('data/augmented_SMILE_18_03_2025.csv')
    ...
    plot_learning_curves(train_losses, val_losses, 'Pre-training Learning Curves', 'pretraining_learning_curves_25_03_2025.png')
    ...
    plot_learning_curves(train_losses, val_losses, 'Fine-tuning Learning Curves', 'finetuning_learning_curves_25_03_2025.png')
    ...
    new_smiles = [generate_smiles(clm_model, char_to_idx, idx_to_char) for _ in range(10000)]
    logging.info("New SMILES generated")
    pd.DataFrame(new_smiles, columns=['SMILES']).to_csv('data/generated_smiles_25_03_2025.csv', index=False)
    logging.info("Generated SMILES saved to 'data/generated_smiles_25_03_2025.csv'")
    ...
    pd.DataFrame(valid_new_smiles, columns=['SMILES']).to_csv('data/valid_unique_smiles_25_03_2025.csv', index=False)
    logging.info("Valid and unique SMILES saved to 'data/valid_unique_smiles_25_03_2025.csv'")
...
#     pd.DataFrame(new_smiles, columns=['SMILES']).to_csv('data/generated_smiles_13_03_2025(2).csv', index=False)
#     logging.info("Generated SMILES saved to 'data/generated_smiles_13_03_2025(2).csv'")
...
#     logging.info("Valid and unique SMILES saved to 'data/valid_unique_smiles_13_03_2025(2).csv'")
